class View:
    def greeting(self):
        print("Приложение для личных заметок. Добро пожаловать!")

    def show_main_menu(self):
        print("Какое действие планируете выполнить? Выберите пункт ниже:\n"
              "\t1. Добавить заметку\n"
    ...
    def error(self):
        print("!!! Введенное число не корректно! Попробуйте еще раз.")
    def not_found(self):
